 ...
 */
export function createMockupFiles(): { sourceFile: FileData; sourceColCFile: FileData; refFile: FileData } {
  ...
  // Now let's create mockup for Column C original file: SKU sits directly in Column C (index 2)
  const sourceColCRaw: any[][] = [
    ['# [Bán Hàng] BẢNG KÊ DOANH SỐ CHI TIẾT SẢN PHẨM'],
    ['Mã Sản phẩm', 'Tên phân loại', 'Mã SKU liên kết (Cột C)', 'Đơn Giá Gốc', 'Giá khuyến mại mới', 'Số lượng có sẵn', 'Mã Kho'],
    ['SP101', 'Loa Bluetooth A36 Cam', 'loa A36 Cam', '650000.00', '600000.00', '10', 'WH-A'],
    ['SP101', 'Loa Bluetooth A36 Tím', 'loa A36 Tím', '650000.00', '600000.00', '15', 'WH-A'],
    ['SP102', 'Mũ Lưỡi Trai Classic DT', 'CAP-CLASSIC-WHT', '150000.00', '120000.00', '25', 'WH-B'],
    ['SP103', 'Giày Sneakers Sport 41', 'SNEAK-SPORT-41', '1250000.00', '1100000.00', '8', 'WH-C']
  ];
  ...
  return {
    ...
    sourceColCFile: {
      name: 'File_Goc_Co_SKU_Cot_C.xlsx',
      size: 11250,
      type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
      rawRows: sourceColCRaw,
      sheetName: 'Sản Phẩm Chi Tiết',
      columnsList: ['A', 'B', 'C', 'D', 'E', 'F', 'G'],
      headers: sourceColCRaw[1] as string[],
      headerRowIndex: 1
    },
    refFile: {
